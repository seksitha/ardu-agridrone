...
#if HAL_WITH_UAVCAN > 1 && !HAL_MINIMIZE_FEATURES && HAL_CANMANAGER_ENABLED
...
#define debug_can(level_debug, fmt, args...) do { AP::canMan().log_text(level_debug, "TestKDECAN",  fmt, ##args); } while (0)
